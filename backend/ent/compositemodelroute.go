...
type CompositeModelRoute struct {
	...
	// Provider model identifier; empty keeps the requested model.
	UpstreamModel string `json:"upstream_model,omitempty"`
	// Endpoint scope such as any, messages, responses, or chat_completions.
	Endpoint string `json:"endpoint,omitempty"`
	// Lower values sort first within the same candidate set.
