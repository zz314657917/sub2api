...
type Group struct {
	...
	// 分组用途：inference, image, video, embedding
	...
	// 是否按上下文长度应用模型阶梯价格；默认开启以保持现有长上下文计费
...
type GroupEdges struct {
	...
	// GroupBuyPlans holds the value of the group_buy_plans edge.
...
// GroupBuyPlansOrErr returns the GroupBuyPlans value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) GroupBuyPlansOrErr() ([]*GroupBuyPlan, error) {
	if e.loadedTypes[4] {
		return e.GroupBuyPlans, nil
	}
	return nil, &NotLoadedError{edge: "group_buy_plans"}
}

// GroupBuyEntitlementsOrErr returns the GroupBuyEntitlements value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) GroupBuyEntitlementsOrErr() ([]*GroupBuyEntitlement, error) {
	if e.loadedTypes[5] {
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case group.FieldModelRouting, group.FieldModelMatchPatterns, group.FieldSupportedModelScopes, group.FieldMessagesDispatchModelConfig, group.FieldModelsListConfig, group.FieldModelPricing:
			values[i] = new([]byte)
		case group.FieldPeakRateEnabled, group.FieldIsExclusive, group.FieldAllowImageGeneration, group.FieldImageRateIndependent, group.FieldClaudeCodeOnly, group.FieldModelRoutingEnabled, group.FieldMcpXMLInject, group.FieldAllowMessagesDispatch, group.FieldAllowLive, group.FieldRequireOauthOnly, group.FieldRequirePrivacySet, group.FieldLongContextPricingEnabled:
...
func (_m *Group) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case group.FieldRoutingScope:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field routing_scope", values[i])
			} else if value.Valid {
				_m.RoutingScope = value.String
			}
...
// QueryGroupBuyPlans queries the "group_buy_plans" edge of the Group entity.
func (_m *Group) QueryGroupBuyPlans() *GroupBuyPlanQuery {
	return NewGroupClient(_m.config).QueryGroupBuyPlans(_m)
}

// QueryGroupBuyEntitlements queries the "group_buy_entitlements" edge of the Group entity.
func (_m *Group) QueryGroupBuyEntitlements() *GroupBuyEntitlementQuery {
...
func (_m *Group) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("routing_scope=")
	builder.WriteString(_m.RoutingScope)
	builder.WriteString(", ")
