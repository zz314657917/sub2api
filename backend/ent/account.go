...
type Account struct {
	...
	// User owner for self-authorized accounts; NULL means system/admin account.
	OwnerUserID *int64 `json:"owner_user_id,omitempty"`
	// User account sharing mode: private or public.
	ShareMode string `json:"share_mode,omitempty"`
	// Public sharing review/runtime status.
	...
	// Parent account id for a linked Spark shadow; NULL for ordinary accounts.
	ParentAccountID *int64 `json:"parent_account_id,omitempty"`
	// Quota dimension: global for ordinary accounts or spark for linked shadows.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldID, account.FieldOwnerUserID, account.FieldProxyID, account.FieldConcurrency, account.FieldLoadFactor, account.FieldPriority, account.FieldParentAccountID:
			values[i] = new(sql.NullInt64)
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldType, account.FieldShareMode, account.FieldShareStatus, account.FieldStatus, account.FieldErrorMessage, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus, account.FieldQuotaDimension:
