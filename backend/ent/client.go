...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.CompositeModelRoute, c.ErrorPassthroughRule, c.Group, c.GroupBuyEntitlement,
		c.GroupBuyEvent, c.GroupBuyPlan, c.GroupBuyRefund, c.GroupBuyRound,
...
type (
	hooks struct {
		...
		ErrorPassthroughRule, Group, GroupBuyEntitlement, GroupBuyEvent, GroupBuyPlan,
		GroupBuyRefund, GroupBuyRound, GroupBuySeat, IdempotencyRecord,
		IdentityAdoptionDecision, InvoiceRequest, PaymentAuditLog, PaymentOrder,
