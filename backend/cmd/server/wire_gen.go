...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	canvasImageTaskCreator := service.ProvideCanvasImageTaskCreator(imageCreatorService)
	canvasService := service.NewCanvasServiceWithDeps(canvasRepository, canvasImageTaskCreator)
