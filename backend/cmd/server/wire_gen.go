...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	compositeRouteAdminService := service.ProvideCompositeRouteAdminService(groupRepository, compositeModelRouteRepository)
	groupHandler := handler.ProvideGroupHandler(adminService, dashboardService, groupCapacityService, groupModelMatchMigration, compositeRouteAdminService)
	...
	cafeRoomHandler := admin.ProvideCafeRoomHandler(cafeRoomService, cafeRoomActivationService, settingService, adminService)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(openAIGatewayService, concurrencyService, billingCacheService, welfareService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, configConfig, coordinator, opsService)
