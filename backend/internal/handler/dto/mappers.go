...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		QuotaDimension:          a.QuotaDimensionOrDefault(),
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	pricingRateMultiplier, balanceConversionMultiplier := service.UsageRateMultiplierBreakdown(l)
	return UsageLog{
		ID:                          l.ID,
		UserID:                      l.UserID,
		APIKeyID:                    l.APIKeyID,
