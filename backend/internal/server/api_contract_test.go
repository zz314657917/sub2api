		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyHomeHeroTitleTop:    "mapleAI",
					service.SettingKeyHomeHeroTitleBottom: "一键接入方案",
					service.SettingKeyHomeHeroSubtitles:   "即刻体验 mapleAI 模型\n添加客服领取试用额度",
			...
			wantJSON: `{
				...
				"data": {
					...
					"turnstile_secret_key_configured": true,
						...
						"home_hero_title_top": "mapleAI",
						"home_hero_title_bottom": "一键接入方案",
						"home_hero_subtitles": "即刻体验 mapleAI 模型\n添加客服领取试用额度",
