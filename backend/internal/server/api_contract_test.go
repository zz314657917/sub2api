		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeyHomeHeroTitleTop:    "ChatGPT",
					service.SettingKeyHomeHeroTitleBottom: "国内直连方案",
					service.SettingKeyHomeHeroSubtitles:   "即刻体验 ChatGPT 最新模型\n添加客服领取试用额度",
			...
			wantJSON: `{
				...
				"data": {
					...
					"turnstile_secret_key_configured": true,
						...
						"home_hero_title_top": "ChatGPT",
						"home_hero_title_bottom": "国内直连方案",
						"home_hero_subtitles": "即刻体验 ChatGPT 最新模型\n添加客服领取试用额度",
...
func (s *stubAccountRepo) RefreshQuotaWindows(ctx context.Context, id int64) error {
	return errors.New("not implemented")
}
...
func (r *stubUsageLogRepo) GetUserLeaderboard(ctx context.Context, startTime, endTime time.Time, limit int, currentUserID int64) (*usagestats.UserLeaderboardResponse, error) {
	return nil, errors.New("not implemented")
}
