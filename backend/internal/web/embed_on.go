...
func (s *FrontendServer) serveIndexHTML(c *gin.Context) {
	...
	// The response CSP contains a fresh nonce on every request. A 304 would
	// reuse HTML with an older nonce and block both the settings and preview
	// scripts, so only the nonce-free template may be cached in memory.
