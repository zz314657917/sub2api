...
const (
	...
	// RequestStartedAt records the first gateway middleware timestamp for a request.
	// Retry and failover selectors reuse it for stable time-window decisions.
	...
	// APIKeyAccountPoolStrategy 当前 API Key 的账号池调度策略。
	APIKeyAccountPoolStrategy Key = "ctx_api_key_account_pool_strategy"
