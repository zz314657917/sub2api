...
// DefaultModelsListReadMaxBytes is the default bounded response size for
// upstream model-list endpoints.
...
type GatewayConfig struct {
	...
	// ModelsListReadMaxBytes limits upstream model-list responses.
...
func setDefaults() {
	...
	viper.SetDefault("gateway.openai_ws.http_bridge_enabled", false)
