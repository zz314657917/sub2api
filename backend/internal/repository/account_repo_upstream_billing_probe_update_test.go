...
func updatedAccountRows(id int64, extra string) *sqlmock.Rows {
	...
	return sqlmock.NewRows(dbaccount.Columns).AddRow(
		...
		[]byte(`{"api_key":"sk-test"}`), []byte(extra), nil,
		service.AccountShareModePrivate, service.AccountShareStatusNotShared, nil, 1, nil, 1, 1.0,
		service.StatusActive, nil, nil, nil, false, true, nil, nil, nil, nil, nil,
		nil, nil, nil,
	)
}
