...
func TestPelicanCostCleanupPostgres(t *testing.T) {
	...
	for _, file := range []string{"../../migrations/243_pelican_tests.sql", "../../migrations/244_pelican_cost_cleanup.sql", "../../migrations/245_pelican_reasoning_effort.sql", "../../migrations/247_pelican_result_reasoning_effort.sql", "../../migrations/248_pelican_plan_timeout.sql", "../../migrations/249_pelican_result_error_details.sql"} {
