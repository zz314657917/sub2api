...
// RedactCyberPolicySensitiveText applies the existing moderation-log secret
// policy to secondary cyber audit sinks such as operations-error records.
func RedactCyberPolicySensitiveText(value string) string {
	return redactContentModerationSecrets(value)
}
