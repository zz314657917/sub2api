...
type UsageLog struct {
	...
	// UpstreamResponseModel is the model declared by the provider response.
	// Nil preserves the distinction between absent observations and an exact match.
	UpstreamResponseModel *string
	// UpstreamModelMismatch compares the sent model with UpstreamResponseModel.
	// Nil means the provider did not declare a model.
