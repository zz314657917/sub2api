...
func shouldAutoInjectPromptCacheKeyForCompat(model string) bool {
	...
	// GPT-6 is the public alias for Astra. Keep this scoped to the exact
	// Astra predicate so unrelated GPT-6 families do not inherit compatibility state.
	if isOpenAIGPT6AstraModel(trimmed) {
		return true
	}
