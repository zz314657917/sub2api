...
func TestOpenAIGatewayServiceForwardImages_OAuthPassesNAndReturnsAllImages(t *testing.T) {
		...
		responses: []*http.Response{
			{
				...
				Body: io.NopCloser(strings.NewReader(
					"data: {\"type\":\"response.completed\",\"response\":{\"created_at\":1710000000,\"usage\":{\"input_tokens\":4,\"output_tokens\":7,\"input_tokens_details\":{\"cached_tokens\":1},\"output_tokens_details\":{\"image_tokens\":2}},\"tool_usage\":{\"image_gen\":{\"input_tokens\":14,\"input_tokens_details\":{\"image_tokens\":4},\"output_tokens\":800,\"output_tokens_details\":{\"image_tokens\":800},\"images\":1}},\"output\":[{\"type\":\"image_generation_call\",\"result\":\"aW1hZ2UtMQ==\",\"revised_prompt\":\"draw a cat 1\",\"output_format\":\"png\",\"quality\":\"high\",\"size\":\"1024x1024\"}]}}\n\n" +
						"data: [DONE]\n\n",
				)),
			},
			{
				...
				Body: io.NopCloser(strings.NewReader(
					"data: {\"type\":\"response.completed\",\"response\":{\"created_at\":1710000000,\"usage\":{\"input_tokens\":3,\"output_tokens\":8,\"input_tokens_details\":{\"cached_tokens\":1},\"output_tokens_details\":{\"image_tokens\":2}},\"tool_usage\":{\"image_gen\":{\"input_tokens\":15,\"input_tokens_details\":{\"image_tokens\":5},\"output_tokens\":800,\"output_tokens_details\":{\"image_tokens\":800},\"images\":1}},\"output\":[{\"type\":\"image_generation_call\",\"result\":\"aW1hZ2UtMg==\",\"revised_prompt\":\"draw a cat 2\",\"output_format\":\"png\",\"quality\":\"high\",\"size\":\"1024x1024\"}]}}\n\n" +
						"data: [DONE]\n\n",
				)),
			},
			{
				...
				Body: io.NopCloser(strings.NewReader(
					"data: {\"type\":\"response.completed\",\"response\":{\"created_at\":1710000000,\"usage\":{\"input_tokens\":4,\"output_tokens\":7,\"input_tokens_details\":{\"cached_tokens\":1},\"output_tokens_details\":{\"image_tokens\":3}},\"tool_usage\":{\"image_gen\":{\"input_tokens\":17,\"input_tokens_details\":{\"image_tokens\":6},\"output_tokens\":859,\"output_tokens_details\":{\"image_tokens\":859},\"images\":1}},\"output\":[{\"type\":\"image_generation_call\",\"result\":\"aW1hZ2UtMw==\",\"revised_prompt\":\"draw a cat 3\",\"output_format\":\"png\",\"quality\":\"high\",\"size\":\"1024x1024\"}]}}\n\n" +
						"data: [DONE]\n\n",
				)),
			},
		},
	...
	require.Equal(t, 15, result.Usage.ImageInputTokens)
...
func TestParseOpenAIImagesSSEUsageBytes_ToolUsagePrecedenceAndFallback(t *testing.T) {
	svc := &OpenAIGatewayService{}
	fallback := OpenAIUsage{InputTokens: 3, OutputTokens: 4, ImageInputTokens: 1, ImageOutputTokens: 2}
	tests := []struct {
		name      string
		toolUsage string
		want      OpenAIUsage
	}{
		{
			...
			toolUsage: `{"input_tokens":4.6e1,"input_tokens_details":{"image_tokens":12},"output_tokens":2459e0,"output_tokens_details":{"image_tokens":24590e-1}}`,
			want:      OpenAIUsage{InputTokens: 46, OutputTokens: 2459, ImageInputTokens: 12, ImageOutputTokens: 2459},
		},
		...
		{name: "invalid optional image input", toolUsage: `{"input_tokens":46,"input_tokens_details":{"image_tokens":"12"},"output_tokens":2459,"output_tokens_details":{"image_tokens":2459}}`, want: fallback},
...
func TestMergeOpenAIUsage_CarriesImageInputTokens(t *testing.T) {
	dst := OpenAIUsage{}
	mergeOpenAIUsage(&dst, []byte(`{"usage":{"input_tokens":371,"input_tokens_details":{"image_tokens":352},"output_tokens":439,"output_tokens_details":{"image_tokens":439}}}`))
	require.Equal(t, 371, dst.InputTokens)
	require.Equal(t, 352, dst.ImageInputTokens)
	require.Equal(t, 439, dst.OutputTokens)
	require.Equal(t, 439, dst.ImageOutputTokens)
}

func TestBuildOpenAIUsageJSON_CarriesImageInputTokens(t *testing.T) {
	usage := OpenAIUsage{ImageInputTokens: 12}
	require.True(t, usage.hasValues())

	encoded := buildOpenAIUsageJSON(usage)
	require.Equal(t, int64(0), gjson.GetBytes(encoded, "input_tokens").Int())
	require.Equal(t, int64(12), gjson.GetBytes(encoded, "input_tokens_details.image_tokens").Int())
}
...
func TestOpenAIGatewayServiceForwardImages_OAuthStreamingTransformsEvents(t *testing.T) {
	...
	require.True(t, result.Stream)
	require.Equal(t, 1, result.ImageCount)
	require.Equal(t, OpenAIUsage{InputTokens: 46, OutputTokens: 2459, ImageInputTokens: 12, ImageOutputTokens: 2459}, result.Usage)
	...
	require.JSONEq(t, `{"input_tokens":46,"input_tokens_details":{"image_tokens":12},"output_tokens":2459,"output_tokens_details":{"image_tokens":2459},"images":1}`, gjson.Get(completed.Data, "usage").Raw)
