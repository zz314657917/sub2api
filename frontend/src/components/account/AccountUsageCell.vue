...
import { cnBalanceCellVisible as isCnBalanceVisible, cnQuotaCellVisible as isCnQuotaVisible } from './credentialsBuilder'
...
const showUsageWindows = computed(() => {
  ...
  if (props.account.platform === 'kimi' || props.account.platform === 'zhipu' || props.account.platform === 'deepseek') return true
...
const cnQuotaCellVisible = computed(() => isCnQuotaVisible(props.account.platform, cnAccountMode.value))
const cnBalanceCellVisible = computed(() => isCnBalanceVisible(props.account.platform, cnAccountMode.value))
