<template>
  <div
    class="rounded-lg border border-[#d8cec2] bg-[#fffaf5] p-4 dark:border-[#cc785c]/30 dark:bg-[#cc785c]/10"
  >
      <div class="flex items-start gap-4">
      <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#fffaf5]0">
        <Icon name="link" size="md" class="text-white" />
      </div>
      <div class="flex-1">
        <h4 class="mb-3 font-semibold text-[#141413] dark:text-[#f0b89e]">{{ oauthTitle }}</h4>

        <!-- Auth Method Selection -->
        <div v-if="showMethodSelection" class="mb-4">
          <label class="mb-2 block text-sm font-medium text-[#504f49] dark:text-[#f0b89e]">
            {{ methodLabel }}
          </label>
          <div class="flex flex-wrap gap-4">
            <label class="flex cursor-pointer items-center gap-2">
              <input
                ...
                type="radio"
                value="manual"
                class="text-[#a9583e] focus:ring-[#cc785c]"
              />
              <span class="text-sm text-[#141413] dark:text-[#f0b89e]">{{
        ...
        <div v-if="inputMethod === 'refresh_token' || inputMethod === 'mobile_refresh_token'" class="space-y-4">
          <div
            class="rounded-lg border border-[#d8cec2] bg-white/80 p-4 dark:border-[#cc785c]/30 dark:bg-gray-800/80"
          >
            <p class="mb-3 text-sm text-[#a9583e] dark:text-[#f0b89e]">
            ...
            <div class="mb-4">
              ...
              >
                <Icon name="key" size="sm" class="text-[#a9583e]" />
                Refresh Token
                <span
                  v-if="parsedRefreshTokenCount > 1"
                  class="rounded-full bg-[#fffaf5]0 px-2 py-0.5 text-xs text-white"
                >
              ...
              <p
                v-if="parsedRefreshTokenCount > 1"
                class="mt-1 text-xs text-[#a9583e] dark:text-[#f0b89e]"
              >
          ...
          >
            ...
            <div class="mb-4">
              ...
              <textarea
                ...
                spellcheck="false"
              ></textarea>
              <p class="mt-1 text-xs text-[#a9583e] dark:text-[#f0b89e]">
            ...
            <div class="mb-4">
              ...
              >
                ...
                <button
                  v-if="showHelp"
                  type="button"
                  class="text-[#a9583e] hover:text-[#a9583e]"
        ...
        <div v-if="inputMethod === 'manual'" class="space-y-4">
          <p class="mb-4 text-sm text-[#504f49] dark:text-[#f0b89e]">
            {{ oauthFollowSteps }}
          </p>
          ...
          >
            <div class="flex items-start gap-3">
              <div
                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#cc785c] text-xs font-bold text-white"
              >
                1
              </div>
              <div class="flex-1">
                <p class="mb-2 font-medium text-[#141413] dark:text-[#f0b89e]">
                ...
                <div v-if="showProjectId && platform === 'gemini'" class="mb-3">
                  <label class="input-label flex items-center gap-2">
                    ...
                    <a
                      ...
                      class="inline-flex items-center gap-1 text-xs font-normal text-[#a9583e] hover:text-[#a9583e] dark:text-[#f0b89e]"
                    >
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <p class="text-sm text-[#a9583e] dark:text-[#f0b89e]">
                  {{ oauthOpenUrlDesc }}
                </p>
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-1">
                ...
                <p
                  class="mb-3 text-sm text-[#a9583e] dark:text-[#f0b89e]"
                  v-text="oauthAuthCodeDesc"
                ></p>
                <div>
                  <label class="input-label">
                    <Icon name="key" size="sm" class="mr-1 inline text-[#a9583e]" />
                    {{ oauthAuthCode }}
                  </label>
                  <textarea
