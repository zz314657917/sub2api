...
@media (max-width: 900px) { .pixel-cafe-scene-stage { min-height: 0; overflow: visible; }.pixel-cafe-scene-visual { position: relative; inset: auto; aspect-ratio: 12 / 5; overflow: hidden; } }
</style>
