...
.pixel-cafe-room-list { position: absolute; z-index: 6; inset: 3rem 1rem 1rem; display: flex; max-width: none; max-height: none; flex-direction: column; margin: 0; padding: .75rem; border-color: transparent; color: #eff5fb; background: transparent; box-shadow: none; pointer-events: none; }.pixel-cafe-room-list-heading { flex: 0 0 auto; align-self: flex-start; padding: .35rem .55rem; border: 1px solid rgba(164, 194, 218, .42); background: rgba(7, 23, 39, .82); box-shadow: 3px 3px 0 rgba(0, 0, 0, .2); }.pixel-cafe-room-list-heading h2 { color: #fff7e5; }.pixel-cafe-room-list-count { color: #aebfcd; }.pixel-cafe-room-cards { display: grid; grid-template-columns: repeat(auto-fit, minmax(15rem, 1fr)); align-content: start; gap: .65rem; min-height: 0; margin-top: .65rem; padding: 0; overflow: visible; }.pixel-cafe-room-card { min-height: 7.4rem; scroll-margin-block: .5rem; border-color: #385369; color: #eff5fb; background: rgba(16, 34, 56, .9); box-shadow: 3px 3px 0 rgba(0, 0, 0, .2); pointer-events: auto; }.pixel-cafe-room-card:hover, .pixel-cafe-room-card:focus-visible, .pixel-cafe-room-card.active { border-color: #efbd68; box-shadow: 3px 3px 0 rgba(0, 0, 0, .24); }.pixel-cafe-room-card-code { color: #f1c26f; }.pixel-cafe-room-card-state { color: #73c99a; }.pixel-cafe-room-card-state.state-blue { color: #8eb4ed; }.pixel-cafe-room-card-state.state-night { color: #d0a4e4; }.pixel-cafe-room-card-plan, .pixel-cafe-room-card-stats, .pixel-cafe-room-list-empty { color: #aebfcd; }.pixel-cafe-room-card-action { color: #efbd68; }
