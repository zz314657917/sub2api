...
const pricingCatalog = {
  zh: {
    ...
    monthlyBonusAvailable: '首次充值赠送可用',
    monthlyBonusClaimed: '首次充值赠送已领',
    noRechargePackages: '后台暂未配置可用积分档位',
    bonusBadge: '送 {amount}',
    creditedAmountLine: '到账 {amount}',
    bonusLine: '首次充值赠送 {amount}',
    bonusClaimedLine: '已领取，到账本金',
    noBonusLine: '无额外赠送',
    bonusAmount: '赠送积分',
    bonusAlreadyClaimedSummary: '已领取',
    newUserDeal: '新人专享',
    orderSummary: '订单摘要',
    rechargeAmount: '购买金额',
    totalPayable: '总计应付',
  ...
  en: {
    ...
    monthlyBonusAvailable: 'First recharge bonus available',
    monthlyBonusClaimed: 'First recharge bonus claimed',
    noRechargePackages: 'No credit packages are currently available',
    bonusBadge: '+ {amount}',
    creditedAmountLine: 'Credits {amount}',
    bonusLine: 'First recharge bonus {amount}',
    bonusClaimedLine: 'Claimed, principal only',
