    ...
    <div class="mx-auto max-w-[92rem] space-y-6">
      ...
      >
        ...
        <div v-show="activeTab === 'security'" class="space-y-6">
          ...
          <!-- API Key IP ACL and forwarded-client-IP settings -->
          <div class="card" data-testid="api-key-acl-settings">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                  ...
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      ...
                      <button
                        ...
                        class="rounded-full text-gray-500 hover:bg-gray-200 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-dark-500 dark:hover:text-white"
                        :aria-label="
                          t('admin.settings.apiKeyAcl.removeForwardedClientIpHeader', { header })
                        "
                    ...
                    >
                      <input
                        ...
                        class="w-full bg-transparent text-sm font-mono text-gray-900 outline-none placeholder:text-gray-400 dark:text-white dark:placeholder:text-gray-500"
                        :placeholder="
                          t('admin.settings.apiKeyAcl.forwardedClientIpHeadersPlaceholder')
                        "
...
const form = reactive<SettingsForm>({
  ...
  // Security client IP resolution; raw forwarded headers remain untrusted by default.
...
type ForwardedClientIpHeaderResult =
  | "added"
  | "duplicate"
  | "invalid"
  | "full";
...
function showForwardedClientIpHeaderError(
  ...
  if (result === "invalid") {
    ...
    appStore.showError(
      t("admin.settings.apiKeyAcl.forwardedClientIpHeaderDuplicate"),
    );
  } else if (result === "full") {
    appStore.showError(
