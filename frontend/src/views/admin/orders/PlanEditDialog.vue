...
watch(() => props.show, (visible) => {
  ...
  if (props.plan) {
    ...
    Object.assign(planForm, { name: '', group_id: props.initialGroupId ?? null, description: '', price: 0, original_price: 0, validity_days: 30, validity_unit: 'days', sort_order: 0, for_sale: true })
