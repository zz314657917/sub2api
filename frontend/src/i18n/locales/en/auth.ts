export default {
    ...
    accessPanelLabel: 'Sign in and registration',
    accessLoginTitle: 'Sign in',
    accessLoginSubtitle: 'Continue with quick sign-in or your account password.',
    accessRegisterTitle: 'Create account',
    accessRegisterSubtitle: 'Create an account to enter your dashboard.',
    accessAgreementPrefix: 'By continuing, you agree to ',
    accessAgreementSeparator: ' and ',
    accessAgreementFallback: 'the Terms of Service and Privacy Policy',
    signIn: 'Sign In',
    ...
    promoCodeValid: 'Valid! You will receive ${amount} bonus credits',
