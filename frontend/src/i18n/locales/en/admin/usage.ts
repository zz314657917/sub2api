export default {
      ...
      responseModelAudit: 'Response Model Audit',
      allResponseModelAudits: 'All Response Model States',
      responseModelMismatch: 'Model Mismatch',
      responseModelMatch: 'Model Match',
      ipAddress: 'IP',
