export default {
      ...
      features: {
        ...
        welfare: {
          ...
          description: 'Control the user welfare center and the Daily Check-in, new-user first recharge gift, and VIP Benefits modules. The gift is granted automatically after an eligible first balance recharge succeeds.',
          ...
          rechargeEnabled: 'Enable New-user First Recharge Gift',
          rechargeEnabledHint: 'When enabled, eligible new users receive the configured gift balance after their first balance recharge succeeds.',
          rechargeReward: 'New-user First Recharge Gift',
          rechargeRewardHint: 'The gift is credited automatically and does not require a manual claim. It does not stack with monthly first recharge packages by default.',
          firstRechargeBonusAmount: 'Gift bonus amount',
          firstRechargeBonusAmountHint: 'Granted after the first positive balance recharge. Set 0 to disable granting.',
          firstRechargeBonusValidDays: 'Valid days after registration',
          firstRechargeBonusValidDaysHint: 'Set 0 for no registration-age limit. Values above 0 require the first recharge within N days.',
          firstRechargeBonusStackMonthly: 'Stack with monthly first recharge',
          firstRechargeBonusStackMonthlyHint: 'When off, the gift is skipped if the first recharge already receives a monthly package bonus.',
        ...
        leaderboardDailyReward: {
          ...
          description: 'Settle balance rewards for last week’s top three spending ranks. Turning it off keeps the values but blocks claims.',
      ...
      payment: {
        ...
        rechargePackagesHint: 'Users can only choose enabled packages. Pay amount must be at least 5, credited amount may include bonus credit.',
        rechargePackageAdd: 'Add Package',
        rechargePackageRemove: 'Remove',
        rechargePackageEnabled: 'Enabled',
        rechargePackageLabel: 'Label',
        rechargePackageLabelPlaceholder: 'e.g. First top-up pack',
        rechargePackagePayAmount: 'Pay Amount',
        rechargePackageCreditedAmount: 'Credited Amount',
