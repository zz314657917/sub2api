export default {
      ...
      features: {
        ...
        welfare: {
          ...
          description: 'Control the user welfare center and the Daily Check-in, new-user first credit purchase gift, and VIP Benefits modules. The gift is granted automatically after an eligible first credit purchase succeeds.',
          ...
          dailyEnabledHint: 'Users can claim one random voucher reward per day and milestone bonuses after streak targets.',
          newUserTrialEnabled: 'Enable New User Trial',
          newUserTrialEnabledHint: 'Allow eligible new users to spend a small API-only trial budget while account credits stay 0.',
          newUserTrial: 'New User Trial',
          newUserTrialHint: 'These credits are not credited to account credits. They can only be consumed by real gateway requests.',
          newUserTrialQuota: 'Trial credits',
          ...
          rechargeEnabled: 'Enable New-user First Credit Purchase Gift',
          rechargeEnabledHint: 'When enabled, eligible new users receive the configured gift credits after their first credit purchase succeeds.',
          rechargeReward: 'New-user First Credit Purchase Gift',
          rechargeRewardHint: 'The gift is credited automatically and does not require a manual claim. It does not stack with first recharge package bonuses by default.',
          firstRechargeBonusAmount: 'Gift bonus credits',
          firstRechargeBonusAmountHint: 'Granted after the first positive credit purchase. Set 0 to disable granting.',
          firstRechargeBonusValidDays: 'Valid days after registration',
          firstRechargeBonusValidDaysHint: 'Set 0 for no registration-age limit. Values above 0 require the first credit purchase within N days.',
          firstRechargeBonusStackMonthly: 'Stack with first recharge bonus',
          firstRechargeBonusStackMonthlyHint: 'When off, the gift is skipped if the first purchase already receives a first recharge package bonus.',
          ...
          rewardHint: 'Granted as vouchers. Spending uses vouchers first, then regular credits.',
          ...
          voucherValidDays: 'Voucher valid days',
          voucherValidDaysHint: 'Set 0 for no expiration. Values above 0 expire after N days from claim time.',
        ...
        leaderboardDailyReward: {
            ...
            mode: 'Reward Mode',
            modeHint: 'Disabled shows usage only; red packet lets each top-10 user claim once; lottery draws one top-10 winner.',
            modes: {
              disabled: 'Disabled',
              redPacket: 'Red Packet',
              lottery: 'Lottery',
            },
            minTotalActualCost: 'Minimum Last Week Spend',
            minTotalActualCostHint: 'Below this threshold the top 10 is still shown, but rewards are not claimable or drawn.',
            rank1Amount: 'Legacy rank 1',
            rank2Amount: 'Legacy rank 2',
            rank3Amount: 'Legacy rank 3',
            redPacketPoolAmount: 'Red Packet Pool',
            redPacketMinAmount: 'Min Packet Amount',
            redPacketMaxAmount: 'Max Packet Amount',
            lotteryAmount: 'Lottery Amount',
            lotteryCron: 'Draw Cron',
            lotteryCronHint: 'Interpreted in the service timezone, for example 0 12 * * 4 means Thursday 12:00.',
          },
        riskControl: {
          title: 'Risk Control',
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; both sides receive a fixed reward automatically after the invitee’s first recharge, while credit purchase percentage rebates remain available. Disabled by default.',
          enabled: 'Enable Affiliate',
          enabledHint: 'When off, the affiliate menu is hidden, the aff parameter is ignored at signup, and new credit purchases generate no rebate. Existing rebate credits can still be transferred.',
          rebateRate: 'Global Rebate Rate',
          rebateRateHint: 'Default percentage given back to the inviter on credit purchases (0-100, e.g. 10 = 10%).',
          apiCallRewardAmount: 'First Recharge Reward',
          apiCallRewardAmountHint: 'Fixed reward amount granted to both inviter and invitee after the invitee completes the first recharge. 0 = disabled.',
      ...
      registration: {
        ...
        riskTitle: 'Registration Risk Controls',
        riskHint: 'Limit rapid registration behavior by IP, device fingerprint, and email domain.',
        riskSuccessfulRegistrationsPerIp: 'Successful signups per IP',
        riskWindowHours: 'Signup window (hours)',
        riskIpUserAgentAttempts: 'IP + UA short-window attempts',
        riskEmailDomainAttempts: 'Email domain short-window attempts',
        riskShortWindowSeconds: 'Short window length (seconds)',
        riskLimitHint: 'Set a limit to 0 or below to disable that limit. Windows at 0 or below use the system default.',
      ...
      security: {
        ...
        sessionBindingHint: 'Bind login sessions to the client IP and User-Agent. Any change immediately invalidates the session and forces re-login.',
      ...
      defaults: {
        ...
        defaultBalance: 'Default Credits',
        defaultBalanceHint: 'Initial credits for new users',
        affiliateRebateRate: 'Affiliate Rebate Rate',
        affiliateRebateRateHint:
          'Rebate percentage credited to inviter after credit purchases (0-100%, e.g. 10 means 10%)',
      ...
      purchase: {
        title: 'Credit Purchase / Subscription Page',
        description: 'Show a "Credit Purchase / Subscription" entry in the sidebar and open the configured URL in an iframe',
        enabled: 'Show Credit Purchase / Subscription Entry',
        enabledHint: 'Only shown in standard mode (not simple mode)',
        url: 'Credit Purchase / Subscription URL',
      ...
      payment: {
        ...
        balanceRechargeMultiplier: 'Credit Purchase Multiplier',
        balanceRechargeMultiplierHint: 'How many credits the user receives for each 1 CNY paid',
        balanceRechargePreview: 'Preview: 1 CNY = {usd} credits',
        rechargeFeeRate: 'Purchase Fee Rate',
        rechargeFeeRateHint: 'Percentage of service fee charged on top of purchase amount, 0 means no fee',
        rechargeFeePreview: 'Preview: Buy 100, fee {fee}',
        rechargePackages: 'Credit Packages',
        rechargePackagesHint: 'Users can only choose enabled packages. Pay amount must be at least 5, credited amount may include bonus credits.',
        rechargePackageAdd: 'Add Package',
        rechargePackageRemove: 'Remove',
        rechargePackageEnabled: 'Enabled',
        rechargePackageLabel: 'Label',
        rechargePackageLabelPlaceholder: 'e.g. First purchase pack',
        rechargePackagePayAmount: 'Pay Amount',
        rechargePackageCreditedAmount: 'Credited Credits',
        rechargePackageBonusAmount: 'Bonus',
        rechargePackageSortOrder: 'Sort',
        faqItems: 'FAQ',
        faqItemsHint: 'Shown on the user purchase page. You can edit titles, content, and order.',
        faqAdd: 'Add question',
        faqItemIndex: 'Question {index}',
        faqTitle: 'Title',
        faqTitlePlaceholder: 'e.g. Quota and billing rules',
        faqBody: 'Content',
        faqBodyPlaceholder: 'Text shown after the user expands this question',
        faqMoveUp: 'Up',
        faqMoveDown: 'Down',
        faqEmpty: 'No FAQ items configured. Defaults will be used when saving.',
        ...
        balancePaymentDisabled: 'Disable Credit Purchase',
      ...
      balanceNotify: {
        ...
        description: 'Send email notification when user credits fall below threshold',
        ...
        rechargeUrl: 'Credit Purchase Page URL',
        rechargeUrlPlaceholder: 'https://example.com/payment',
        rechargeUrlHint: 'A purchase button will appear in the email when set',
      },
      quotaNotify: {
      ...
      authSourceDefaults: {
        ...
        description: 'Configure per-source default credits, concurrency, subscriptions, and grant rules.',
