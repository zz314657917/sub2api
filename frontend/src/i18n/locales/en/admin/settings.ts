export default {
      ...
      features: {
        ...
        welfare: {
          ...
          description: 'Control the user welfare center and the Daily Check-in, first recharge bonus, and VIP Benefits modules. The first recharge bonus is granted automatically after the first balance recharge succeeds.',
          ...
          rechargeEnabled: 'Enable Recharge Rewards',
          rechargeEnabledHint: 'When enabled, the user receives the configured first recharge balance bonus after their first balance recharge succeeds.',
          rechargeReward: 'Recharge Rewards',
          rechargeRewardHint: 'The first recharge bonus is credited automatically and does not require a manual claim.',
          firstRechargeBonusAmount: 'First recharge bonus amount',
