export default {
      ...
      features: {
        ...
        welfare: {
          ...
          rechargeRewardHint: 'The gift is credited automatically and does not require a manual claim. It does not stack with monthly first-purchase package bonuses by default.',
          ...
          firstRechargeBonusStackMonthly: 'Stack with monthly first purchase',
          firstRechargeBonusStackMonthlyHint: 'When off, the gift is skipped if the first purchase already receives a monthly package bonus.',
        ...
        leaderboardDailyReward: {
          title: 'Leaderboard Weekly Rewards',
          description: 'Settle credit rewards for last week’s top three spending ranks. Turning it off keeps the values but blocks claims.',
          enabled: 'Enable Weekly Rewards',
          enabledHint: 'Only the top three can claim when last week’s total spend is strictly above the minimum threshold.',
          minTotalActualCost: 'Minimum Last Week Spend',
          minTotalActualCostHint: 'Last week’s total spend must be strictly greater than this amount.',
          rank1Amount: 'Rank 1',
          rank2Amount: 'Rank 2',
          rank3Amount: 'Rank 3',
        },
