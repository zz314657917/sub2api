export default {
      ...
      features: {
        ...
        affiliate: {
          ...
          description: 'Existing users invite new ones; the inviter can claim a fixed reward after the invitee’s first API call, while credit purchase percentage rebates remain available. Disabled by default.',
