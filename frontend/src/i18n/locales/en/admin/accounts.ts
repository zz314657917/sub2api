export default {
      ...
      cnProviders: {
        ...
        apiProtocol: {
          ...
          anthropic: 'Anthropic',
          anthropicDesc: 'Native passthrough to the provider Anthropic endpoint, ideal for Claude Code.',
          responses: 'Responses',
      ...
      upstreamBilling: {
        ...
        upstreamBalance: 'Upstream {kind}: {value} {unit}',
        upstreamBalanceQuota: 'key quota remaining',
        upstreamBalanceWallet: 'wallet balance',
        upstreamBalanceSubscription: 'subscription remaining',
        upstreamBalanceInline: 'Remaining: {value} {unit}',
        upstreamBalanceInlineUnlimited: 'Remaining: unlimited',
        upstreamBalanceUnlimited: 'Upstream {kind}: unlimited',
        upstreamBalanceUnsupported: 'Upstream balance: unsupported',
        upstreamBalanceUnavailable: 'Upstream balance: unavailable',
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'Converges OAuth device and session identifiers to stable account values. Off preserves client identifiers and is the default.',
      ...
      syncUpstreamModelsMetadataPartial: 'Complete model capabilities were updated; incomplete entries retain their previous metadata.',
