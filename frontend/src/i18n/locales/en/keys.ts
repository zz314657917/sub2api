export default {
    ...
    multiGroupRoutingHint: 'Match group rules; drag to set priority',
    routeConfig: 'Route Config',
    priority: 'Priority',
    weight: 'Weight',
    cooldownSeconds: 'Cooldown (s)',
    seconds: 's',
    firstResponseTimeoutEnable: 'Switch groups on timeout',
    firstResponseTimeoutBulkSeconds: 'Bulk first-response timeout seconds',
    firstResponseTimeoutApplyAll: 'Apply to all',
    firstResponseTimeoutPrefix: 'No response for',
    firstResponseTimeoutSuffix: 's, switch to next group',
    firstResponseTimeoutDisabled: 's (default)',
    firstResponseTimeoutRouteSeconds: 'Wait time for this group in seconds. With 0, the first selected group does not switch automatically; later groups inherit its wait time',
    firstResponseTimeoutInvalid: 'Enter a whole number from 1 to 600 seconds; individual groups also accept 0 as explained in Switching rules',
    firstResponseTimeoutHint: 'If no valid response arrives in time, try the next available group. Set a different wait time for each group if needed.',
    firstResponseTimeoutRules: 'Switching rules',
    firstResponseTimeoutLimitHint: 'Switching stops after a valid response. Total waiting is capped at 120 seconds, or the longest group setting if higher, up to 600 seconds.',
    firstResponseTimeoutScopeHint: 'Applies only to stateless inference. If the first selected group is set to 0, this request will not switch groups. Once switching begins, later groups set to 0 inherit the first group’s wait time. Bound accounts, upstream sessions, image, video, and WebSocket requests are excluded.',
    dragRoute: 'Drag to reorder route priority',
    addRoute: 'Add Route',
    allRouteGroupsAdded: 'All available groups have been added',
    removeRoute: 'Remove route',
    routeEnabled: 'Enabled',
    routeSubscriptionExpired: 'Subscription unavailable',
    routeGroupUnavailable: 'Group unavailable',
    routeGroupUnavailableWithId: 'Group #{id} · unavailable',
    routeUnavailableHint: 'Currently unavailable. Keep it to restore automatically after renewal, or remove this route.',
