  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        copyOfficialPrices: 'Fill from official reference',
        officialReferencePrice: 'Official est. ${price}',
        officialReferenceTitle: 'Official reference: gpt-image-2 {size} {quality}, about ${price} per image',
        officialReferenceHint: 'Official reference prices come from OpenAI image generation docs: 1K uses the 1024x1024 table price; 2K/4K are estimated from the gpt-image-2 output token calculator for representative sizes. Use them as cost references and adjust your selling prices.',
