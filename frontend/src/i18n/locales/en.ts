export default {
  ...
  welfare: {
    ...
    trial: {
      ...
      description: 'Free quota can be claimed after your first real API call.',
      cta: 'Complete first call',
      total: 'Trial quota',
      used: 'Used',
      remaining: 'Remaining',
      activationNotice: 'Make your first real API call with an API key to activate and consume the free quota automatically.',
      walletNotice: 'Trial quota is only for first API access. It will not enter your wallet balance.',
