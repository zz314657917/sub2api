export default {
  ...
  openWebUI: {
    ...
    subtitle: 'The legacy Open WebUI launch flow is disabled by default. Use the native Chat & Images workspace.',
    apiKey: 'API Key',
    loadingKeys: 'Loading available API keys',
    selectKey: 'Select API key',
    noKeysTitle: 'No usable API keys yet',
    noKeysHint: 'The Open WebUI compatibility flow requires an active API key. The native Chat & Images workspace is recommended.',
    createKey: 'Create API Key',
    ...
    unlimited: 'Unlimited',
    launchPanelTitle: 'Launch Open WebUI',
    launchPanelHint: 'Only available when the Open WebUI integration is explicitly enabled on the backend. Use the native Chat & Images workspace by default.',
    launch: 'Launch Open WebUI',
    opening: 'Opening',
    loadKeysFailed: 'Failed to load API keys',
    popupBlocked: 'The new tab was blocked by your browser. Allow pop-ups and try again.',
    launchFailed: 'Failed to open Open WebUI'
  },

  chatImageStudio: {
    title: 'Chat & Images',
    subtitle: 'Chat, generate images, review the gallery, and track image tasks inside Sub2API',
