export default {
  ...
  dashboard: {
    ...
    onboarding: {
      ...
      trialTitle: 'Complete your first call to claim free credits',
      ...
      rewardDescription: 'Create an API key and send one real API request, then claim free credits in Welfare.',
      ...
      rewardNotice: 'After the first successful call, open Welfare to claim it. Claimed credits can be used for API calls.',
      pillAutoActivate: 'Auto-deducts on first call',
      pillBalanceDeduct: 'Deducts on usage',
      pillFirstCallReward: 'Claim after first call',
      ...
      stepKeyDescription: 'Generate an API key first, then use it in Codex, Claude Code or another tool.',
      ...
      stepRewardCallDescription: 'Send one real request to meet the new-user reward requirement.',
      stepRewardTitle: 'Claim {amount}',
      stepRewardDescription: 'After the first successful call, open Welfare to claim free credits.',
  ...
  openWebUI: {
    ...
    createKey: 'Create API Key',
    keyPrivacyHint: 'The real API key is redeemed and bound server-side. It is never placed in the browser URL.',
    active: 'Active',
