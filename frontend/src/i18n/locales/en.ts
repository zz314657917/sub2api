export default {
  ...
  myAccounts: {
    ...
    oauthCodePlaceholder: 'Paste the code after authorization',
    generateAuthUrl: 'Generate Auth URL',
    oauthHint: 'Open the auth URL, finish login, then paste the returned code here before saving.',
    oauthMissing: 'Generate an auth URL and enter the OAuth code first',
