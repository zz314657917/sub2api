export default {
  ...
  openWebUI: {
    title: 'Chat & Images',
    subtitle: 'Select a Sub2API API key and enter the standalone chat and image workspace',
    apiKey: 'API Key',
    loadingKeys: 'Loading available API keys',
    selectKey: 'Select API key',
    noKeysTitle: 'No usable API keys yet',
    noKeysHint: 'Create and bind an active API key before opening Open WebUI for chat and images.',
    createKey: 'Create API Key',
    ...
    unlimited: 'Unlimited',
    launchPanelTitle: 'Enter Open WebUI',
    launchPanelHint: 'This creates a short-lived one-time login token and opens the chat and image workspace in a new tab.',
    launch: 'Open Chat & Images',
    opening: 'Opening',
    loadKeysFailed: 'Failed to load API keys',
