export default {
  ...
  leaderboard: {
    ...
    dailyReward: {
      ...
      threshold: 'Yesterday spend threshold',
      ...
      thresholdNotMet: 'Yesterday spend did not exceed the minimum threshold',
      notTopThree: 'Only yesterday’s top three can claim',
      notRanked: 'You had no ranked spend yesterday',
      zeroReward: 'This rank has a zero reward amount',
      eligible: 'You are eligible to claim',
      alreadyClaimed: 'Yesterday’s reward has been claimed',
      claim: 'Claim Reward',
      claiming: 'Claiming...',
      claimed: 'Claimed',
  ...
  keys: {
    ...
    multiGroupRoutingHint: 'Enable priority and weight based routing for multiple groups on one key. The default group above is only used as fallback.',
    ...
    routeDuplicateGroup: 'Route groups cannot be duplicated',
  ...
  chatImageStudio: {
    ...
    embeddedOpenFailedDescription: 'Could not create an image workspace launch link. Check the Open WebUI configuration or try again later.',
  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        officialReferencePrice: 'Billing est. ${price}',
        officialReferenceTitle: 'APIMart billing reference: gpt-image-2-official {size} {quality}, about ${price} per image',
        officialReferenceHint: 'Billing reference is APIMart "our price" × 7 CNY/USD × 1.2. This deployment treats 1 balance unit as ¥1, so saved values are charged as per-image channel prices.',
    ...
    accounts: {
      ...
      shareDisplay: {
        ...
        display5hUsed: 'Display 5h Base Used',
        display7dLimit: 'Display 7d Limit',
        display7dUsed: 'Display 7d Base Used',
        ...
        display5hUsedHint: 'Used as the display baseline. The capacity pool adds the account usage from the last 5 hours.',
        display7dLimitHint: 'When set, this is preferred for the OpenAI Pro/Plus 7d window display.',
        display7dUsedHint: 'Used as the display baseline. The capacity pool adds the account usage from the last 7 days.'
      },
    ...
    settings: {
      ...
      features: {
        ...
        welfare: {
          ...
          description: 'Control the user welfare center and the Daily Check-in, Recharge Rewards, and VIP Benefits modules. Recharge and VIP are placeholders in this phase.',
          enabled: 'Enable Welfare System',
          enabledHint: 'When off, the user welfare entry is hidden and all claim endpoints are denied.',
          dailyEnabled: 'Enable Daily Check-in',
          dailyEnabledHint: 'Users can claim one random balance reward per day and milestone bonuses after streak targets.',
          newUserTrialEnabled: 'Enable New User Trial',
          newUserTrialEnabledHint: 'Allow eligible new users to spend a small API-only trial budget while wallet balance stays 0.',
          newUserTrial: 'New User Trial',
          newUserTrialHint: 'This quota is not credited to wallet balance. It can only be consumed by real gateway requests.',
          newUserTrialQuota: 'Trial quota amount',
          newUserTrialSuccessReward: 'Success reward amount',
          newUserTrialSiteLimit: 'Daily site trial spend cap',
          newUserTrialIpLimit: 'Daily IP activation cap',
          rechargeEnabled: 'Recharge Rewards reserved switch',
          rechargeEnabledHint: 'Only reserves the future entry. This phase does not show a recharge reward claim flow.',
          vipEnabled: 'VIP Benefits reserved switch',
          vipEnabledHint: 'Only reserves the future entry. This phase does not show a VIP claim flow.',
          reservedBadge: 'Reserved',
          randomReward: 'Daily Random Reward',
          rewardMin: 'Minimum amount',
          rewardMax: 'Maximum amount',
          rewardHint: 'Credited to user balance. Saving normalizes max to be at least min.',
          minAccountAgeHours: 'Hours after registration before check-in',
          ...
          milestone28: '28-day streak',
        },
        leaderboardDailyReward: {
          title: 'Leaderboard Daily Rewards',
          description: 'Settle balance rewards for yesterday’s top three spending ranks. Turning it off keeps the values but blocks claims.',
          enabled: 'Enable Daily Rewards',
          enabledHint: 'Only the top three can claim when yesterday’s total spend is strictly above the minimum threshold.',
          minTotalActualCost: 'Minimum Yesterday Spend',
          minTotalActualCostHint: 'Yesterday’s total spend must be strictly greater than this amount.',
          rank1Amount: 'Rank 1',
          rank2Amount: 'Rank 2',
          rank3Amount: 'Rank 3',
        },
        ...
        imageStorageGovernance: {
          title: 'Image Storage Governance',
          description: 'Inspect image file usage, expired images, orphan files, preview cache, and thumbnail cache, then run safe cleanup actions.',
          storageBackend: 'Storage Backend',
          storageDir: 'Local Storage Directory',
          images: 'Total Images',
          expiredImages: 'Expired Images',
          orphanFiles: 'Orphan Files',
          previewCache: 'Preview Cache',
          thumbCache: 'Thumbnail Cache',
          cleanExpiredImages: 'Clean Expired Images',
          cleanOrphanFiles: 'Clean Orphan Files',
          cleanPreviewCache: 'Clean Preview Cache',
          cleanThumbCache: 'Clean Thumbnail Cache',
          cleaning: 'Cleaning',
          cleaned: 'Cleaned {count} items and freed {size}',
          unsupported: 'Local traversal is unsupported for the current storage backend',
          loadFailed: 'Failed to load image storage governance data',
          cleanFailed: 'Failed to clean image storage',
        },
        affiliate: {
      ...
      site: {
        ...
        homeHeroTitleTop: 'Home Hero Title Line 1',
        homeHeroTitleTopPlaceholder: 'mapleAI',
        homeHeroTitleTopHint: 'Leave empty to use the default first title line',
        homeHeroTitleBottom: 'Home Hero Title Line 2',
        homeHeroTitleBottomPlaceholder: 'Intelligent Solutions',
        homeHeroTitleBottomHint: 'Leave empty to use the default second title line',
        homeHeroSubtitles: 'Home Rotating Subtitles',
        homeHeroSubtitlesPlaceholder:
          'Connect AI model capabilities through one gateway.\nFollow the quick start and claim trial credits.',
        homeHeroSubtitlesHint:
          'One subtitle per line. The homepage cycles through them; leave empty to use the defaults.',
        ...
        remove: 'Remove',
        logoHint: 'PNG, JPG, WebP, or SVG. Max 300KB. Recommended: 80x80px square image.',
