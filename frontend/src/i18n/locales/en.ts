export default {
  ...
  dashboard: {
    ...
    onboarding: {
      ...
      trialTitle: 'New-user perk is ready',
      ...
      stepRewardTitle: 'Claim {amount} balance',
      stepRewardDescription: 'After the first successful call, claim the reward into your wallet from Welfare.',
