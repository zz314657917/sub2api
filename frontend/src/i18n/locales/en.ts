export default {
  ...
  myAccounts: {
    ...
    oauth: 'OAuth',
    wizardHint: 'First version focuses on OAuth, Setup Token, Session Key, and Token JSON. API Key/URL/Cookie are advanced imports.',
    ...
    settings: {
      ...
      site: {
        ...
        homeHeroSubtitlesPlaceholder:
          'Try the latest ChatGPT models. Contact support to claim trial credits.\nUse GPT-5, Claude, Gemini, and more through one unified key.',
