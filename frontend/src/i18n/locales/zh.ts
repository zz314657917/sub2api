export default {
  ...
  home: {
    ...
    heroTitleBottom: '一键接入方案',
    heroSubtitle: 'mapleAI 一键接入方案',
    heroDescription: '按需付费，随用随停',
    heroDescriptionAltModels: '完成教程接入API，领免费额度',
    heroDescriptionAltSupport: '统一密钥接入，按需启用模型能力',
    claimButton: '注册领取试用',
    contactSupport: '添加客服',
    tags: {
  ...
  admin: {
    ...
    accounts: {
      ...
      shareDisplay: {
        title: '共享展示包装',
        hint: '用于把自己的 API Key 作为共享容量放入池子，前端展示为指定套餐并按额度百分比呈现。',
        displayName: '展示名称',
    ...
    settings: {
      ...
      site: {
        ...
        homeHeroTitleBottomPlaceholder: '一键接入方案',
