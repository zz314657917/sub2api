  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        copyOfficialPrices: '按官方参考填充',
        officialReferencePrice: '官方约 ${price}',
        officialReferenceTitle: '官方参考：gpt-image-2 {size} {quality} 约 ${price} / 张',
        officialReferenceHint: '官方参考价来自 OpenAI 图片生成文档：1K 采用 1024x1024 表格价格；2K/4K 按 gpt-image-2 output token calculator 对代表尺寸估算，仅作成本参考，请按你的售价自行调整。',
