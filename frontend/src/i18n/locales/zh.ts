export default {
  ...
  dashboard: {
    ...
    onboarding: {
      ...
      rewardNotice: '首次调用成功后，进入福利中心领取；领取后可用于 API 调用。',
      pillAutoActivate: '首调用自动抵扣',
      pillBalanceDeduct: '调用自动扣减',
      pillFirstCallReward: '首次调用后领取',
      ...
      skip: '暂时跳过',
      stepKeyTitle: '创建密钥',
      stepKeyDescription: '先生成 API Key，用它接入 Codex、Claude Code 或其他工具。',
      stepToolTitle: '接入工具',
      ...
      stepRewardCallDescription: '发送一次真实请求，完成新人福利领取条件。',
      stepRewardTitle: '领取 {amount}',
      stepRewardDescription: '首次调用成功后，进入福利中心领取免费额度。',
      stepUsageTitle: '查看用量',
  ...
  openWebUI: {
    ...
    keyPrivacyHint: '真实 API Key 只会在服务端兑换并绑定到生图工作台，不会出现在浏览器 URL 中。',
    active: '可用',
    imageReady: '支持生图',
    group: '分组',
    platform: '平台',
