export default {
  ...
  openWebUI: {
    title: '聊天生图',
    subtitle: '选择一个 API Key 后进入独立聊天生图页面',
    apiKey: 'API Key',
    loadingKeys: '正在加载可用 API Key',
    selectKey: '选择 API Key',
    noKeysTitle: '还没有可用 API Key',
    noKeysHint: '创建并绑定一个 active API Key 后，就可以直达 Open WebUI 聊天和生图。',
    ...
    neverExpires: '永久有效',
    unlimited: '不限额度',
    launchPanelTitle: '进入 Open WebUI',
    launchPanelHint: '点击后会生成短期一次性登录令牌，并在新标签页打开聊天生图。',
    launch: '打开聊天生图',
    opening: '正在打开',
