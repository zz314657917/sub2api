export default {
  ...
  leaderboard: {
    ...
    dailyReward: {
      ...
      thresholdNotMet: '昨日总消费未超过最低开启门槛',
      notTopThree: '只有昨日榜前三名可以领取',
      notRanked: '你昨日暂无上榜消费',
      zeroReward: '当前名次奖励额度为 0',
      eligible: '你已符合领取条件',
      alreadyClaimed: '昨日奖励已领取',
      claim: '领取奖励',
      claiming: '领取中...',
      claimed: '已领取',
  ...
  chatImageStudio: {
    ...
    embeddedOpenFailedDescription: '无法创建生图工作台登录链接，请检查 Open WebUI 配置或稍后重试。',
  ...
  admin: {
    ...
    groups: {
      ...
      imagePricing: {
        ...
        officialReferencePrice: '扣费约 ${price}',
        officialReferenceTitle: 'APIMart 扣费参考：gpt-image-2-official {size} {quality} 约 ${price} / 张',
        officialReferenceHint: '扣费参考价按 APIMart「我们的价格」× 汇率 7 × 1.2 计算；本系统余额按 1 数值 = ¥1 使用，保存后会作为渠道每张图片单价扣费。',
    ...
    accounts: {
      ...
      dataImportHint: '上传导出的 JSON 文件，或只包含 accounts 数组的账号文件，以批量导入账号与代理。',
      ...
      share: {
        ...
        approve: '通过',
        reject: '拒绝',
        reviewSuccess: '共享审核已更新',
        reviewFailed: '共享审核更新失败'
      },
      ...
      quotaLimitHint: '设置日/周/月/总使用额度（美元），任一维度达到限额后账号暂停调度。Anthropic API Key 账号还可配置客户端亲和。修改限额不会重置已用额度。',
      ...
      quotaMonthlyLimit: '月限额',
      quotaMonthlyLimitHint: '从首次使用起每 30 天自动重置。',
      quotaTotalLimit: '总限额',
      quotaTotalLimitHint: '累计消费上限，不会自动重置 — 使用「重置配额」手动清零。',
      shareDisplay: {
        title: '移动到容量池',
        hint: '选择 Plus 或 Pro 后，这个 OpenAI 账号会在共享容量池中归入对应套餐池。',
        displayName: '自定义池名',
        displayNamePlaceholder: '例如 OpenAI Pro 容量',
        displayTier: '目标池子',
        displayTierHint: '不移动时按账号自身套餐或默认共享池展示；选 Plus/Pro 会移动到对应池。',
        autoPool: '不移动到套餐池',
        accountCount: '按账号数计入',
      ...
      bulkActions: {
        ...
        rejectShare: '批量拒绝共享',
        suspendShare: '批量暂停共享',
        approveFilteredShare: '通过当前筛选',
        rejectFilteredShare: '拒绝当前筛选',
        suspendFilteredShare: '暂停当前筛选',
        resetStatusSuccess: '已成功重置 {count} 个账号状态',
        refreshTokenSuccess: '已成功刷新 {count} 个账号令牌',
        shareStatusSuccess: '已成功更新 {count} 个共享账号',
        shareStatusSuccessWithSkipped: '已成功更新 {count} 个共享账号，跳过 {skipped} 个：{detail}',
        shareStatusPartial: '共享审核部分完成：{success} 成功，{failed} 失败，{skipped} 跳过。{detail}',
        shareStatusSkippedAll: '所选账号不适用于当前操作，已跳过 {skipped} 个：{detail}',
        shareStatusNoTargets: '当前筛选下没有可处理的共享账号',
        shareStatusConfirmTitle: '确认批量审核',
        shareStatusConfirmMessage: '将对当前筛选下 {count} 个账号执行“{action}”。确认后会立即批量处理。',
        shareStatusConfirmSampleTitle: '将处理的账号样例',
        shareStatusResultTitle: '共享审核结果',
        shareStatusResultModeSelected: '已勾选账号',
        shareStatusResultModeFiltered: '当前筛选全部',
        shareStatusResultSummary: '{mode}：{success} 成功，{failed} 失败，{skipped} 跳过',
        shareStatusResultAccount: '账号',
        shareStatusResultStatus: '结果',
        shareStatusResultReason: '说明',
        shareStatusResultSuccess: '成功',
        shareStatusResultFailed: '失败',
        shareStatusResultSkipped: '跳过',
        shareStatusResultSkippedReason: '状态不适用于当前操作',
        shareStatusResultCopyAll: '复制全部结果',
        shareStatusResultCopyFailed: '复制失败 ID',
        shareStatusResultCopySkipped: '复制跳过 ID',
        shareStatusResultRetryFailed: '重试失败项',
        shareStatusResultClose: '关闭',
    ...
    settings: {
      ...
      features: {
        ...
        leaderboardDailyReward: {
          title: '排行榜每日奖励',
          description: '按昨日消费榜结算前三名余额奖励。关闭后保留配置，但用户不能领取。',
          enabled: '启用每日奖励',
          enabledHint: '仅当昨日总消费严格超过最低门槛时，前三名可领取对应余额奖励。',
          minTotalActualCost: '昨日总消费最低门槛',
          minTotalActualCostHint: '必须严格超过该金额才开启昨日榜奖励。',
          rank1Amount: '第 1 名',
          rank2Amount: '第 2 名',
          rank3Amount: '第 3 名',
        },
