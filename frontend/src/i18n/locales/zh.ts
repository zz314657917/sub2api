export default {
  ...
  home: {
    ...
    heroDescriptionAltSupport: '国内网络直连，无需翻墙',
    claimButton: '注册领取试用',
    contactSupport: '添加客服',
    tags: {
  ...
  myAccounts: {
    ...
    notesPlaceholder: '可选',
    oauth: 'OAuth 授权',
    wizardHint: '首版主推 OAuth、Setup Token、Session Key 和 Token JSON；API Key/URL/Cookie 属于高级导入。',
  ...
  admin: {
    ...
    settings: {
      ...
      site: {
        ...
        homeHeroTitleBottomPlaceholder: '国内直连方案',
