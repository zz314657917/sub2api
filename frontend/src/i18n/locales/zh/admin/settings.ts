export default {
      ...
      features: {
        ...
        welfare: {
          ...
          rechargeRewardHint: '礼包自动到账，不需要用户手动领取；默认不与每月首购档位赠送叠加。',
          ...
          firstRechargeBonusStackMonthly: '允许叠加每月首购',
          firstRechargeBonusStackMonthlyHint: '关闭时，首笔购买如果已经获得每月首购档位赠送，则不再额外发礼包。',
