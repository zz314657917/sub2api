export default {
      ...
      features: {
        ...
        welfare: {
          title: '福利系统',
          description: '控制用户端福利中心，以及每日签到、首冲赠送、VIP 福利三个模块。首冲赠送会在首次余额充值到账后自动发放。',
          enabled: '启用福利系统',
          ...
          rechargeEnabled: '启用充值福利',
          rechargeEnabledHint: '开启后，用户首次余额充值到账成功时可自动获得配置的首冲赠送余额。',
          rechargeReward: '充值福利',
          rechargeRewardHint: '首冲福利自动到账，不需要用户手动领取。',
          firstRechargeBonusAmount: '首冲赠送金额',
          firstRechargeBonusAmountHint: '首次余额充值任意正金额后发放；填 0 表示不发放。',
