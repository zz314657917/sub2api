export default {
      ...
      features: {
        ...
        welfare: {
          title: '福利系统',
          description: '控制用户端福利中心，以及每日签到、新用户首充礼包、VIP 福利三个模块。新用户首充礼包会在符合条件的首次余额充值到账后自动发放。',
          enabled: '启用福利系统',
          ...
          rechargeEnabled: '启用新用户首充礼包',
          rechargeEnabledHint: '开启后，新用户符合条件的首次余额充值到账成功时可自动获得配置的礼包余额。',
          rechargeReward: '新用户首充礼包',
          rechargeRewardHint: '礼包自动到账，不需要用户手动领取；默认不与每月首充档位赠送叠加。',
          firstRechargeBonusAmount: '礼包赠送金额',
          firstRechargeBonusAmountHint: '用户首次余额充值任意正金额后发放；填 0 表示不发放。',
          firstRechargeBonusValidDays: '注册后有效天数',
          firstRechargeBonusValidDaysHint: '填 0 表示不限制注册时间；大于 0 时仅注册后 N 天内首次充值可领。',
          firstRechargeBonusStackMonthly: '允许叠加每月首充',
          firstRechargeBonusStackMonthlyHint: '关闭时，首笔充值如果已经获得每月首充档位赠送，则不再额外发礼包。',
      ...
      payment: {
        ...
        rechargePackages: '充值档位',
        rechargePackagesHint: '用户只能选择启用中的档位；每档支付金额最低 5 元，到账额度可高于支付金额。',
        rechargePackageAdd: '新增档位',
        rechargePackageRemove: '删除',
        rechargePackageEnabled: '启用',
        rechargePackageLabel: '名称',
        rechargePackageLabelPlaceholder: '如：首充体验包',
        rechargePackagePayAmount: '支付金额',
        rechargePackageCreditedAmount: '到账额度',
