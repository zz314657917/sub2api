export default {
      ...
      upstreamBilling: {
        ...
        upstreamBalance: '上游{kind}：{value} {unit}',
        upstreamBalanceQuota: 'Key 剩余额度',
        upstreamBalanceWallet: '钱包余额',
        upstreamBalanceSubscription: '订阅剩余额度',
        upstreamBalanceInline: '剩余：{value} {unit}',
        upstreamBalanceInlineUnlimited: '剩余：无限制',
        upstreamBalanceUnlimited: '上游{kind}：无限制',
        upstreamBalanceUnsupported: '上游余额：不支持',
        upstreamBalanceUnavailable: '上游余额：暂不可用',
      ...
      allPlanTypes: '全部 OpenAI 套餐',
      planTypeOther: '其他',
      planTypeUnrecognized: '未识别',
      privacyUnset: '未设置',
      ...
      cnProviders: {
        ...
        apiProtocol: {
          ...
          anthropic: 'Anthropic',
          anthropicDesc: '直通供应商原生 Anthropic 端点，适配 Claude Code。',
          responses: 'Responses',
      ...
      openai: {
        ...
        wsMode: 'WS mode',
        wsModeDesc:
          '仅对当前 OpenAI 账号类型生效；ctx_pool、passthrough 等账号 WS mode 仅在全局 gateway.openai_ws.mode_router_v2_enabled=true 时生效。',
        wsModeOff: '关闭（off）',
      ...
      syncUpstreamModelsMetadataPartial: '已更新完整的模型能力；信息不完整的条目保留原有能力。',
