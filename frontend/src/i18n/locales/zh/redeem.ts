export default {
    ...
    codeRule2: '兑换码可以增加积分、并发数或试用权限',
    codeRule3: '如有兑换问题，请联系客服',
    codeRule4: '积分和并发数即时更新',
    recentActivity: '最近活动',
    historyWillAppear: '您的兑换历史将显示在这里',
    balanceAddedRedeem: '积分兑换（兑换码）',
    balanceAddedAffiliate: '积分转入（返利）',
    balanceAddedLeaderboardReward: '积分奖励（排行榜）',
    balanceAddedNewUserReward: '积分奖励（新手试用）',
    balanceAddedFirstRechargeBonus: '积分赠送（首充）',
    system: '系统',
    balanceAddedAdmin: '积分增加（管理员）',
    balanceDeductedAdmin: '积分扣除（管理员）',
