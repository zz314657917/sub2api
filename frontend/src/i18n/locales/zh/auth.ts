export default {
    ...
    accessPanelLabel: '登录和注册',
    accessLoginTitle: '登录',
    accessLoginSubtitle: '使用快捷登录或账号密码继续。',
    accessRegisterTitle: '注册',
    accessRegisterSubtitle: '创建账号后即可进入仪表盘。',
    accessAgreementPrefix: '继续即表示你同意',
    accessAgreementSeparator: '和',
    accessAgreementFallback: '本站服务条款和隐私政策',
    signIn: '登录',
    signingIn: '登录中...',
    createAccount: '创建账户',
