...
describe('home page visual direction', () => {
  ...
  it('uses the full-width translucent top navigation treatment', () => {
    ...
    expect(homeView).toContain('home-nav-center')
    expect(homeView).toContain('home-mobile-nav')
    expect(homeView).toContain('home-nav-pill')
    expect(homeView).toContain("t('home.navFeatures')")
    expect(homeView).toContain("t('home.navTutorial')")
    expect(homeView).toContain("t('home.navModels')")
    expect(homeView).toContain('to="/tutorial"')
    expect(homeView).toContain('to="/models"')
