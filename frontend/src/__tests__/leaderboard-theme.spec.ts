...
describe('leaderboard visual identity', () => {
  ...
  it('shows last week top 10 token usage and reward-mode panels instead of old rank reward cards', () => {
    ...
    expect(leaderboardView).toContain('leaderboard-weekly-winner-user')
    ...
    expect(leaderboardView).toContain('lastWeekLotteryWinnerText')
    expect(leaderboardView).toContain("t('leaderboard.dailyReward.lastWeekLotteryWinner')")
